...
const getStatusColor = (status: string) => {
    return STATUS_CONFIG[status]?.color || "bg-gray-500/10 text-gray-700 border-gray-500/20";
};
                ...
                <Card className="bg-card/80 backdrop-blur-sm border-border/40 mb-6">
                    <CardContent className="py-4">
                        <div className="flex items-center justify-between">
                            ...
                            <Button onClick={goToToday} variant="secondary" className="gap-2">
                            ...
                            {Object.keys(eventsByDate).length > 0 && (
                                <div className="mt-6 pt-6 border-t border-border/40">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {Array.from(
                                            new Set<string>(data?.data?.map((e) => e.status) || [])
                                        ).map((status) => (
                                            <Badge
                                                key={status}
                                                variant="outline"
                            ...
                            {Object.keys(eventsByDate).length === 0 && (
                                <div className="text-center py-12">
                                    ...
                                    <p className="text-sm text-muted-foreground mb-6">
                                        You don't have any scheduled events for {monthName}
                                    </p>
                                    <Link href="/catalog">
