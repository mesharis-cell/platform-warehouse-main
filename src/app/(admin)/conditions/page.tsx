                ...
                stats={
                    data
                        ? {
                              ...
                              value: (
                                  Number(data.meta.summary.red_count) +
                                  Number(data.meta.summary.orange_count)
                              ).toString(),
                          }
                        : undefined
                }
            ...
            <div className="p-6 font-mono">
                                    ...
                                    <span className="font-mono text-4xl font-bold tabular-nums">
                                        {isLoading ? (
                                            ...
                                            (
                                                ...
                                                Number(data?.meta.summary.orange_count || 0)
                                            ).toString()
                                        )}
                                    </span>
                                    <span className="text-sm font-normal text-muted-foreground">
                ...
                <div className="space-y-4">
                    {isLoading ? (
                        ...
                        data?.data.map((item) => (
                            <Link key={item.id} href={`/assets/${item.id}`} className="block">
                                <Card
