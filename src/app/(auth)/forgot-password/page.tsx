                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="animate-in fade-in slide-in-from-top-6 duration-700 delay-250 mb-6">
                        <div className="flex items-center justify-center gap-3">
                            ...
                            >
                                <div
                                    className={`h-8 w-8 rounded-full flex items-center justify-center text-xs font-mono font-bold border-2 transition-colors ${step === "email" ? "bg-primary text-primary-foreground border-primary" : "bg-primary/10 border-primary/20 text-primary"}`}
                                >
                                    1
                                </div>
                            ...
                            <div
                                className={`w-8 h-0.5 ${step === "verify" ? "bg-primary" : "bg-border"} transition-colors`}
                            />
                            <div
                                className={`flex items-center gap-2 ${step === "verify" ? "text-primary" : "text-muted-foreground"}`}
                            >
                                <div
                                    className={`h-8 w-8 rounded-full flex items-center justify-center text-xs font-mono font-bold border-2 transition-colors ${step === "verify" ? "bg-primary text-primary-foreground border-primary" : "bg-muted border-border"}`}
                                >
                                    2
                                </div>
                                <span className="text-xs font-mono uppercase tracking-wider hidden sm:inline">
