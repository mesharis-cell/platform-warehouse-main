...
export function CollectionItemsList({ collectionId }: { collectionId: string }) {
    ...
    return (
        <div className="space-y-6">
            {/* Info Banner */}
            <div
                className={`${allAvailable ? "bg-primary/10 border-primary/20" : "bg-amber-500/10 border-amber-500/20"} border rounded-lg p-4 flex items-start gap-3`}
            >
                {allAvailable ? (
                    ...
                    {allAvailable ? (
                        <>
                            ...
                            <p className="text-xs text-muted-foreground">
                                This collection is fully in stock. You can order the complete
                                collection or customize your selection.
                            </p>
                        </>
                    ) : (
                        <>
                ...
                <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="bg-muted/30 rounded-lg p-4 border border-border/50">
                        ...
                        <p className="text-2xl font-bold font-mono text-primary">
                            {Number(collection.totalVolume).toFixed(2)} m³
                        </p>
                    </div>
                    <div className="bg-muted/30 rounded-lg p-4 border border-border/50">
                        <p className="text-xs font-mono text-muted-foreground uppercase tracking-wide mb-1">
                        ...
                        <p className="text-2xl font-bold font-mono">
                            {Number(collection.totalWeight).toFixed(1)} kg
                        </p>
                    </div>
                </div>
            </div>
                ...
                <DialogContent className="max-w-4xl max-h-[90vh] p-0">
                    {collection && (
                        <CollectionCustomizer
                            ...
                            onAddToCart={handleAddSelectedItems}
