                ...
                <div className="flex flex-col sm:flex-row h-full">
                    ...
                    <div className="flex-1 p-3 sm:p-4 min-w-0 flex flex-col justify-center">
                        ...
                        <div className="flex items-start justify-between gap-2 mb-1">
                            <div>
                                <h3 className="text-base font-bold truncate pr-2 leading-tight">
                                    {item.name}
                                </h3>
                        ...
                        {item.handling_tags && item.handling_tags.length > 0 && (
                            <div className="flex flex-wrap gap-1 mt-2">
                                {item.handling_tags.map((tag) => (
                                    <span
                                        key={tag}
                                        className="text-[10px] px-1.5 py-0.5 bg-muted/50 rounded border border-border/50 text-muted-foreground font-mono"
                                    >
                                        {tag}
                                    </span>
                                ))}
